...
public class MyDrawerAdapter extends BaseAdapter{
    ...
    public MyDrawerAdapter(Context context, String[] titles, int[] images,int[] selectedposition) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.fragment_my_activity11, null);
        ...
        if (position == selectedposition[0]) {
            convertView.setBackgroundColor(Color.rgb(255,145,0));
