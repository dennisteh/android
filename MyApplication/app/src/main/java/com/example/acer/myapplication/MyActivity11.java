...
public class MyActivity11 extends Activity
   ...
   // }
    ...
    public void onNavigationDrawerItemSelected(int position) {
       ...
       //         .commit();
        if(position==0){
            fragmentManager.beginTransaction()
                    .replace(R.id.container,PromotionFragment.newInstance())
                    .commit();
        }else if(position==1){
            fragmentManager.beginTransaction()
                    .replace(R.id.container,OutletFragment.newInstance())
                    .commit();
        }else if(position==2){
            fragmentManager.beginTransaction()
                    .replace(R.id.container,MVFragment.newInstance())
                    .commit();
        }else if(position==3){
            fragmentManager.beginTransaction()
    ...
    public void onSectionAttached(int number) {
        ...
        switch (number) {
            ...
            case 1:
                ...
                break;
            case 2:
                mTitle = getString(R.string.title_outlet);
                break;
            case 3:
            ...
            case 8:
                ...
                break;
            case 9:
                mTitle = getString(R.string.title_signup);
                break;
        }
    }
